...
image_0 = Image.open('C:\\Users\\tejal\\OneDrive\\Desktop\\pycam.jpg')
...
selfie = Image.open("C:\\Users\\tejal\\OneDrive\\Desktop\\grp_selfie.jpg")
...
gallery_btn = tk.Button(root, textvariable=gallery_text, command=lambda: gallery(), font="Raleway", bg="#14a76c",
                        fg="white", height=3, width=25)
